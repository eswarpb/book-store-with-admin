...
const Footer = () => {
  return (
    <footer className='mb-4'>
      <div className='rounded-tr-3xl rounded-tl-3xl pt-12 xl:pt-20 pb-8'>
        ...
        <div className='flex justify-between flex-wrap gap-2
          ...
          <div className='max-w-sm'>
            ...
            <p className='py-4'>Bookshops are places of endless entertainment and renewal.what’s not to love??</p>
      ...
      {/* copyrights */}
      <p className='text-white bg-tertiary medium-14 py-2 px-8 rounded flexBetween '><span>2025 BeStore</span><span>All rights reserved</span></p>
    </footer>
  )
}
